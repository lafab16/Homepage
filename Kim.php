<div class="wrapper-main">
    <section class="section-default">
      ...
      <form id="myForm" method="POST" action="...">
        <input id="field_username" class="inputfield" title="Username must not be blank and contain only letters, numbers and underscores." type="text" required pattern="\w+" name="username" placeholder="Username">
